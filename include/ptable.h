 ...
 *
 * Copyright (C) 1989 - 1992, 2003, 2004, 2006
...
// of templates to C++.
#define PTABLE(T) CONCAT(T,_ptable)
#define PASSOC(T) CONCAT(T,_passoc)
#define PTABLE_ITERATOR(T) CONCAT(T,_ptable_iterator)
